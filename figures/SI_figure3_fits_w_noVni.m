...
% experimentally We compare the temperature-driven model with a model without
% non-infectious virus stage (for the pair MicB/MicV-B).
...
% Save figure
print(hfig,'-depsc','-r600','outputs/SI_Figure3_fits_noVni.eps')
print(hfig,'-dpdf','-r600','outputs/SI_Figure3_fits_noVni.pdf')
